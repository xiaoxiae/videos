...
def animate_augment_path_partial(self, g, path, add_animations_first=None, add_animations_between=None, add_animations_second=None, instant=False, switch=False, run_time=None):
    """If animations is lambda, do them only here I don't know that I'm doing."""
    # NOTE: duplicit but only used in the thumbnail to highlight the alternating path
    A = path
    AV = edgesToVertices(A)
